...
int main(void)
{
	...
	if ((dict = dictInit(n)) == NULL)
	{
		printf("dictInit() failed :(\n");
		return (1);
	}
	...
	art_name = "Mona Lisa";		printf("price for art name \'%s\' is: %d\n", art_name, searchPrice(dict, art_name));
	art_name = "Van Gogh";		printf("price for art name \'%s\' is: %d\n", art_name, searchPrice(dict, art_name));
	art_name = "Picasso";		printf("price for art name \'%s\' is: %d\n", art_name, searchPrice(dict, art_name));
	art_name = "lhernand";		printf("price for art name \'%s\' is: %d\n", art_name, searchPrice(dict, art_name));
	art_name = "Claude Monet";			printf("price for art name \'%s\' is: %d\n", art_name, searchPrice(dict, art_name));
	art_name = "Salvador Dali";			printf("price for art name \'%s\' is: %d\n", art_name, searchPrice(dict, art_name));
	art_name = "Frida Rivera";	printf("price for art name \'%s\' is: %d\n", art_name, searchPrice(dict, art_name));
