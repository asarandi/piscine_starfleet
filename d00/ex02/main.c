...
int main(void)
{
	...
	art_name = "Mona Lisa";		printf("price for the art \'%s\' is %d\n", art_name, searchPrice(arts, n, art_name));
	art_name = "Picasso";		printf("price for the art \'%s\' is %d\n", art_name, searchPrice(arts, n, art_name));
	art_name = "I dont exist";	printf("price for the art \'%s\' is %d\n", art_name, searchPrice(arts, n, art_name));
	art_name = "Van Gogh";		printf("price for the art \'%s\' is %d\n", art_name, searchPrice(arts, n, art_name));
